          ...
          >
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  <input 
                    ...
                    required
                    placeholder="••••••••"
                    className="w-full px-4 py-3 rounded-xl border border-border focus:border-primary-container focus:ring-2 focus:ring-primary-container/20 outline-none transition-all text-foreground bg-background pr-12"
                    value={password}
              ...
              <button 
                type="submit" 
                disabled={isLoading}
                className="w-full mt-2 bg-[#f59e0b] text-white py-3.5 rounded-xl font-bold hover:bg-[#d97706] shadow-md hover:shadow-lg transition-all disabled:opacity-70 disabled:cursor-not-allowed"
              >
