...
const RadialPulseLoader = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center radial-pulse-loader gap-4">
      <canvas ref={canvasRef}></canvas>
      {showText && <div className="text-white font-bold tracking-widest text-sm animate-pulse">{text}</div>}
    </div>
  );
};
